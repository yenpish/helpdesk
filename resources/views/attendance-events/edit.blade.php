...
@section('content')
    ...
    <form method="POST" action="{{ route('attendance-events.update', $event) }}">
        @csrf
        @method('PATCH')
        ...
        <div class="field">
            ...
            <input
                ...
                id="start_date"
                name="start_date"
                value="{{ old('start_date', $event->starts_at?->format('Y-m-d')) }}"
                required
            >
        </div>
        ...
        <div class="field">
            ...
            <input
                ...
                id="end_date"
                name="end_date"
                value="{{ old('end_date', $event->ends_at?->format('Y-m-d')) }}"
                required
            >
        </div>
        ...
        <div class="field">
            ...
            <input
                ...
                id="start_time"
                name="start_time"
                value="{{ old('start_time', $event->starts_at?->format('H:i')) }}"
                required
            >
        </div>
        ...
        <div class="field">
            ...
            <input
                ...
                id="end_time"
                name="end_time"
                value="{{ old('end_time', $event->ends_at?->format('H:i')) }}"
                required
            >
        </div>
